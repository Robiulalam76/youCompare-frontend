                ...
                <div className='grid grid-cols-1 gap-4'>
                    <div>
                        <div className='flex justify-between items-center w-full'>
                            ...
                            <button className='w-8 h-8 hover:bg-sky-200 rounded-full text-sm flex justify-center items-center hover:text-white'><span>X</span></button>
                        </div>
