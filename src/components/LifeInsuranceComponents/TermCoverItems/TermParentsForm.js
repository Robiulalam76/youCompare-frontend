    ...
    return (
        <div className='grid md:grid-cols-2 gap-x-6 gap-y-2'>
            ...
            <div className='relative mb-2 w-full'>
                ...
                </div>
                {
                    showItems === 2 && <div className='absolute z-50 top-16 border shadow w-full max-h-44 overflow-y-auto'>
                        {
                            options?.map(item => (
                                <button onClick={() => handleSelectFatherOption(item)} className='w-full h-10 flex justify-start items-center bg-white hover:bg-gray-100 px-4'>
                                    <h1 className='text-sm'>{item}</h1>
                                </button>
                            ))
                        }
            ...
            <div className='relative mb-2 w-full'>
                ...
                {
                    showItems === 3 && <div className='absolute z-50 top-16 border shadow w-full max-h-44 overflow-y-auto'>
                        {
                            options?.map(item => (
                                <button onClick={() => handleSelectMotherOption(item)} className='w-full h-10 flex justify-start items-center bg-white hover:bg-gray-100 px-4'>
                                    <h1 className='text-sm'>{item}</h1>
                                </button>
                            ))
                        }
