    ...
    return (
        <main className='bg-gradient-to-r from-blue-100 via-purple-100 to-sky-100 min-h-screen'>
            ...
            <div className='flex justify-between w-full min-h-screen'>
                <div className='flex flex-col min-w-fit pt-4 md:w-56 border-r border-sky-500 shadow-sm min-h-screen bg-gradient-to-b from-blue-200 to-sky-200'>
                ...
                <div className='flex-grow w-full h-full p-2 md:p-4 lg:p-6'>
                    {children}
                </div>
            </div>
