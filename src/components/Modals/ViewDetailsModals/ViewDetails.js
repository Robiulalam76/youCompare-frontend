            ...
            <div ref={outSideRef}
                ...
                <div className='mt-8'>
                    <div className='flex justify-between items-center'>
                        ...
                        <Link to="/buy" className='flex justify-center items-center border shodow rounded-md w-fit px-3 md:px-6 h-12 text-white bg-rose-600 hover:bg-rose-700 duration-150'>
