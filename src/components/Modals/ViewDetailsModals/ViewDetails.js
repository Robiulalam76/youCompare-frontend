...
const ViewDetails = ({ closeModal }) => {
  ...
  return (
    <div className="flex justify-center fixed z-50 w-full h-full top-0 left-0 bg-opacity-50 bg-gray-900 cursor-pointer md:py-4 p-4">
      ...
      >
        <h1 className="text-center font-bold text-blue-900 mt-6 text-2xl">
          Doese Everythink Look Correct
        </h1>
        <p className="text-blue-900 text-xl text-center mt-4">
          Before proceeding, please take a moment to review the information
          provided below:
        </p>
        ...
        <div className="flex justify-between items-center gap-2 mt-6">
          ...
          <button
            ...
            className="flex justify-center items-center border shodow rounded-md w-fit px-3 md:px-6 h-12 text-white bg-rose-600 hover:bg-rose-700 duration-150"
          >
        ...
        <div className="mt-8">
          <div className="flex justify-between items-center">
            <h1 className="text-left font-bold text-2xl mb-4 text-blue-900">
              Your Qoute Details
            </h1>
            <Link
              to="/buy"
          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="bg-white border shadow w-full h-fit p-3 md:p-6 rounded-md">
              <h1 className="text-center font-bold text-xl mb-4 text-gray-900">
                Vehicle Summary
              </h1>
