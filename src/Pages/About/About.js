...
const img1 =
  "https://glampcity-app.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ffree.02c67620.png&w=64&q=75";
const img2 =
  "https://glampcity-app.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcash.e54c14f0.png&w=64&q=75";
const img3 =
  "https://glampcity-app.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fproduct.00d341b4.png&w=48&q=75";
const img4 =
  "https://glampcity-app.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsupport.0936ad81.png&w=64&q=75";
...
const items = [
  {
    ...
    title: "Free Delivery",
    description:
      "Experience the convenience of free delivery on all your orders. We understand the importance of timely delivery, and that is why we offer this service to ensure your satisfaction.",
  },
  {
    id: "1",
    img: img2,
    title: "100% Cash Back",
    description:
      "Shop with confidence knowing that we provide a 100% cash back guarantee. If you are not completely satisfied with your purchase, simply let us know, and we will refund your money without any hassle.",
  },
  {
    id: "1",
    img: img3,
    ...
    description:
      "We take pride in offering only the highest quality products to our customers. Each item goes through a rigorous quality check to ensure that you receive nothing but the best. Shop with us and experience superior craftsmanship and durability.",
  },
  {
    id: "1",
    img: img4,
    title: "24/7 Support",
    description:
      "Our dedicated customer support team is available round the clock to assist you with any queries or concerns. We believe in providing excellent customer service and strive to address your needs promptly and efficiently.",
  },
];
  ...
  return (
    <div className="bg-white pt-12">
      ...
      <div className="cursor-pointer grid md:grid-cols-2 lg:grid-cols-4 gap-4 mt-16 px-4">
        {items.map((item) => (
          <div className="flex flex-col justify-center items-center gap-4 w-full h-60 border shadow-md shadow-blue-300 p-3">
        ...
        <div className="container flex flex-col items-center p-4 mx-auto">
          ...
          <div className="relative mt-6 mb-12">
            ...
            <input
              ...
              name="Search"
              placeholder="Search..."
              className="w-full py-3 pl-12 text-sm rounded-full sm:w-96 focus:outline-none  text-gray-100 focus:bg-slate-100"
            />
          </div>
