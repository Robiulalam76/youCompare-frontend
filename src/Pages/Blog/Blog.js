                ...
                <section className="bg-white text-gray-100">
                    <div className="container max-w-full mx-auto space-y-6 sm:space-y-12">
                        ...
                        <div className="flex justify-center">
                            <button type="button" className="px-6 py-3 text-sm rounded-md hover:underline bg-primary text-white">Load more posts...</button>
                        </div>
                    </div>
                </section>
                                ...
                                <div className="grid gap-4 md:grid-cols-2">
                                    <div className="grid content-center gap-4">
                                        <div className="p-6 rounded shadow-md bg-slate-100">
                                            ...
                                            <div className="flex items-center mt-4 space-x-4">
                                                <img src="https://source.unsplash.com/51x51/?portrait" alt="" className="w-12 h-12 bg-cover rounded-full" />
                                                <div>
                                        ...
                                        <div className="p-6 rounded shadow-md bg-slate-100">
                                            ...
                                            <div className="flex items-center mt-4 space-x-4">
                                                <img src="https://source.unsplash.com/52x52/?portrait" alt="" className="w-12 h-12 bg-cover rounded-full" />
                                                <div>
                                                    <p className="text-lg font-semibold">Leroy Jenkins</p>
                                                    <p className="text-sm text-gray-400">CTO of Company Co.</p>
                                                </div>
                                    ...
                                    <div className="grid content-center gap-4">
                                        <div className="p-6 rounded shadow-md bg-slate-100">
                                            ...
                                            <div className="flex items-center mt-4 space-x-4">
                                                <img src="https://source.unsplash.com/53x53/?portrait" alt="" className="w-12 h-12 bg-cover rounded-full" />
                                                <div>
                                                    <p className="text-lg font-semibold">Leroy Jenkins</p>
                                                    <p className="text-sm text-gray-400">CTO of Company Co.</p>
                                                </div>
                                        ...
                                        <div className="p-6 rounded shadow-md bg-slate-100">
                                            ...
                                            <div className="flex items-center mt-4 space-x-4">
                                                <img src="https://source.unsplash.com/54x54/?portrait" alt="" className="w-12 h-12 bg-cover rounded-full" />
                                                <div>
                                                    <p className="text-lg font-semibold">Leroy Jenkins</p>
                                                    <p className="text-sm text-gray-400">CTO of Company Co.</p>
                                                </div>
